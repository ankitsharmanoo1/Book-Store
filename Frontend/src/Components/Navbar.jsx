...
const Navbar = () => {
  ...
  <div className="navbar-start">
    <div className="dropdown">
      ...
      <ul
        ...
        {/* {["Home", "Course", "Contact" ,"about"].map((item,index)=>(<li key={index}><a>{item}</a></li>))} */}
        {navItems}
         
      </ul>
    </div>
    <a className=" text-2xl bold cursor-pointer">BookStore</a>
  </div>
  ...
  <input type="text" className=" grow outline-none dark:bg-slate-900 dark:text-white rounded-md px1" placeholder="Search" />
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 16 16"
    fill="currentColor"
